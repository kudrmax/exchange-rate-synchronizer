...
def create_object(db: Session, model: Type[ModelType], schema: SchemaType) -> ModelType:
...
def update_object(db: Session, model: Type[ModelType], obj_id: Any, schema: SchemaType) -> ModelType:
...
def get_object(db: Session, model: Type[ModelType], obj_id: Any) -> Optional[ModelType]:
